...
public class LoginLockoutException  extends LoginAttemptException{
    ...
    public LoginLockoutException(SPCodeEnum msg, Throwable t, ValidateUser validateUser) {
        super(msg, t, validateUser);
    }

    public LoginLockoutException(SPCodeEnum msg, ValidateUser validateUser) {
