...
@Component
public class SPVideo extends CPStoredProcedure
{

    private static final String SP_NAME = "P_VIDEO";

    // SP PARAM NAMES
    public static final String OUT_CURSOR = "salCursor";
    public static final String OUT_STATUS = "salStatus";
    public static final String IN_MESSAGEID = "pIdChat";

    @Autowired
    public SPVideo(JdbcTemplate jdbcTemplate)
    {
    ...
    {
        getSimpleJdbcCall()
        .useInParameterNames(IN_MESSAGEID)
        .declareParameters(
                new SqlOutParameter(OUT_STATUS, Types.VARCHAR),
                new SqlParameter(IN_MESSAGEID, Types.BIGINT))
