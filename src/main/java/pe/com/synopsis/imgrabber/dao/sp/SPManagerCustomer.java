...
@Component
public class SPManagerCustomer extends CPStoredProcedure
{

    private static final String SP_NAME = "P_MGR_CUSTOMER";
    ...
    public static final String IN_IDCUSTOMER = "pIdCustomer";

    @Autowired
    public SPManagerCustomer(JdbcTemplate jdbcTemplate)
    {
    ...
    public void configSP()
    {
        ...
        .useInParameterNames(IN_NAME, IN_APEPAT, IN_APEMAT, 
                IN_MOBILE, IN_PHONE, IN_EMAIL, IN_IDCUSTOMER)
        .declareParameters(
                ...
                new SqlParameter(IN_IDCUSTOMER, Types.BIGINT));
    }
