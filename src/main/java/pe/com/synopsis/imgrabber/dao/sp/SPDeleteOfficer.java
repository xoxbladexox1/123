...
@Component
public class SPDeleteOfficer extends CPStoredProcedure
{

    private static final String SP_NAME = "P_DEL_OFFICER";
    ...
    @Autowired
    public SPDeleteOfficer(JdbcTemplate jdbcTemplate)
    {
